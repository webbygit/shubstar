...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyAe7C0m9E4aR82NrCVnmN6iSwJxTlzH_y0")

        setUpSlideMenu()
        if let identifierForVendor = UIDevice.current.identifierForVendor {
            print(identifierForVendor.uuidString)
            UserDefaults.standard.set(identifierForVendor.uuidString, forKey: "uuidKey") //setObject
    ...
    func setUpSlideMenu() {
        ...
        let vc = storyBord.instantiateViewController(withIdentifier: "LeftSlideViewController")
...
//        SlideNavigationController.sharedInstance().landscapeSlideOffset = 1024-158
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "SalesTrack")
