...
namespace Salestrack.Service.Services
{
    ...
    public class SalespersonGoalService : ServiceBase<SalespersonGoal>, ISalespersonGoalService
    {
        public SalespersonGoalService(ISalespersonGoalRepository repository) : base(repository)
        {
        }
    }
