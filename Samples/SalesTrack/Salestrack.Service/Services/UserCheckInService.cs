...
namespace Salestrack.Service.Services
{
    ...
    public class UserCheckInService : ServiceBase<UserCheckIn>, IUserCheckInService
    {
        public UserCheckInService(IUserCheckInRepository repository) : base(repository)
        {
        }
    }
