...
namespace Salestrack.Service.Services
{
    ...
    public class CompanyLicenseService : ServiceBase<CompanyLicense>, ICompanyLicenseService
    {
        public CompanyLicenseService(ICompanyLicenseRepository repository) : base(repository)
        {
        }
    }
