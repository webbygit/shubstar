...
{
    // This class need to be ignored as we are using SalestrackDBContext which inherits from
    // IdentityDbContext<ApplicationUser> which is further derived from DbContext
    // We need functionlaity in IdentityDbContext<ApplicationUser> in our app as we are using Identity EF6

    public class xDataContext : DbContext, IDataContextAsync
    {
        ...
        public xDataContext(string nameOrConnectionString) : base(nameOrConnectionString)
        {
